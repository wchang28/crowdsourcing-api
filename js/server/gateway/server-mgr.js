...
var ServerManager = (function (_super) {
    ...
    function ServerManager(availablePorts, serverMessenger) {
...
function get(availablePorts, serverMessenger) { return new ServerManager(availablePorts, serverMessenger); }
exports.get = get;
